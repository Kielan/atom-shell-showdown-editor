...
=======
	...
	//I added this plugin to showdown not a very specific name
	text = _DoPlaceholder(text);
	

>>>>>>> c3419f2540ee1e658f91eb8088525312234d48b2
...
//
	...
	html = '<div data-id="' + m2 +  '" class="placeholder_drop">';
		html += '<i class="fa fa-camera-retro fa-5x"></i><br> Add an image of <strong>' + m2 + '</strong></div>';
		return html;
    }
